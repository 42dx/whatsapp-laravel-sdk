...
class WhatsappServiceProvider extends ServiceProvider {
    public const SERVICE_NAME = 'whatsapp';

    public const CONFIG_FILENAME = self::SERVICE_NAME . '.php';

    public const CONFIG_PATH = __DIR__ . '/../config/' . self::CONFIG_FILENAME;

    public const MIGRATIONS_PATH = __DIR__ . '/../database/migrations';

    public const PUBLISH_TAG_PREFIX = 'whatsapp-business-api-';
